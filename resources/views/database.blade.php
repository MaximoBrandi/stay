                            ...
                            @foreach (App\Models\Team::all() as $value)
                                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                    <div class="border border-t-0 border-neutral-200 bg-white dark:border-neutral-600 dark:bg-neutral-800">
                                        <h2 class="mb-0" id="headingCourse{{ $value->id }}">
                                            <button
                                                ...
                                                type="button" data-te-collapse-init data-te-collapse-collapsed data-te-target="#collapseCourse{{ $value->id }}"
                                                aria-expanded="false" aria-controls="collapseCourse{{ $value->id }}">
                                                {{ $value->name }}
                                                <span
                                                    class="-mr-1 ml-auto h-5 w-5 shrink-0 rotate-[-180deg] fill-[#336dec] transition-transform duration-200 ease-in-out group-[[data-te-collapse-collapsed]]:mr-0 group-[[data-te-collapse-collapsed]]:rotate-0 group-[[data-te-collapse-collapsed]]:fill-[#212529] motion-reduce:transition-none dark:fill-blue-300 dark:group-[[data-te-collapse-collapsed]]:fill-white">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                        ...
                                        <div id="collapseCourse{{ $value->id }}" class="!visible hidden" data-te-collapse-item aria-labelledby="headingCourse{{ $value->id }}">
